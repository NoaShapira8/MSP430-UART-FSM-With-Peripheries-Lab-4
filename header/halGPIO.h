...
extern void Get_X_Delay(void) ;
extern void Int2Str(char *str, unsigned int num);
extern int str2int( char volatile *str) ;
extern void rotateRight(unsigned long int *value, unsigned int rotateBy) ;
extern void rotate32BitInt(unsigned long int *value) ;
extern void Calc_float(unsigned int x) ;
extern unsigned int Get_ADC_Val(void) ;
extern void ADC10_on(void) ;
extern void ADC10_off(void) ;
extern void Timer_A0_Off(void) ;
extern void Timer_A1_Off(void) ;
extern void CLR_RGB(void) ;
extern void CLR_LCD(void) ;
extern void Stop_Buzzer(void) ;
extern void Timer_A1_On(void) ;
